...
class TfTree {
    ...
    lookup_transform(parent_frame, child_frame, layer) {
        ...
        //console.log(branches_copy);
//        if(branches_copy.length>=1){
//            for(let z=0;z<branches_copy.length;z++){
//                if(branches_copy[z].tree.frame_id=="odom" || branches_copy[z].tree.frame_id=="map"
//                    || branches_copy[z].tree.frame_id=="base_link"){
//                    console.log(branches_copy[z].tree.frame_id);
//                }
//            }
//            
//        }
